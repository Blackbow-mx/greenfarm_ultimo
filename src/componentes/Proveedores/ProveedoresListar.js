...
let apiEliminarRegistros = "admin/proveedores/delete/";
let localListarRegistros = "/proveedores/listar";
let apiConsultaRegistro  = "admin/proveedores/listar/";
let apiConfig            = "admin/proveedores/init/"
...
telefono:"",
   ...
   // console.log("boton: " + e.target.id);
    ...
    cargarDatos = async ()=>{
		const{correo,domicilio,encargado,nombre,telefono} = this.state.form;
...
<>
 ...
 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Domicilio</h6><input  style={{borderradius: "2px",border: "1px solid rgb(217,217,217)",marginTop: "2%",width: "100%"}}  className="form-control form-control-sm" type="text"   name="domicilio" onChange={this.cambioValor} value={this.state.form.domicilio}  />
        </div>
 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Encargado</h6><input  style={{borderradius: "2px",border: "1px solid rgb(217,217,217)",marginTop: "2%",width: "100%"}}  className="form-control form-control-sm" type="text"   name="encargado" onChange={this.cambioValor} value={this.state.form.encargado}  />
        </div>
 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
