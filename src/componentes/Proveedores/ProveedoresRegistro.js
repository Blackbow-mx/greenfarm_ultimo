...
let localListarRegistros  = "/proveedores/listar";
let apiEditarRegistro     = "admin/proveedores/update/";
let apiShowRegistro       = "admin/proveedores/show/";
let apiCrearRgistro       = "admin/proveedores/crear"
let localEditarRegistros  = "/proveedores/editar/";
let localInicio           = "/";
let localRegistrar        = "/proveedores/alta";


class ProveedoresAlta extends React.Component {
    ...
    EnviarDatos= async (e) =>{
        ...
        e.preventDefault();
        const{correo,domicilio,encargado,nombre,telefono}= this.state.registro;
...
this.props.history.push( localListarRegistros); 
     ...
     async componentDidMount(){
        ...
        this.setState({leyendaTitulo:"Editando Proveedores", datosCargados:true,registro:JSON.parse(resultOk) })
        }
        else
        {
            this.setState({leyendaTitulo:"Agregando Proveedores", datosCargados:true})
...
<div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingbottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Domicilio</h6>
                                            <input type="text" className="form-control"  name="domicilio" onChange={this.cambioValor} value={registro.domicilio} placeholder="Domicilio"  />
                                            <br/>
                                        </div>
<div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingbottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Encargado</h6>
                                            <input type="text" className="form-control"  name="encargado" onChange={this.cambioValor} value={registro.encargado} placeholder="Encargado"  />
                                            <br/>
                                        </div>
<div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingbottom: "12px",height: "auto"}}>
