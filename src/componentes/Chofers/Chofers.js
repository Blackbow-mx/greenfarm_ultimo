...
let apiEliminarRegistros = "admin/chofers/delete/";
let localListarRegistros = "/chofers/listar";
let apiConsultaRegistro  = "admin/chofers/listar/";
let apiConfig            = "admin/chofers/init/"
...
class Chofers  extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            datosCargados: false,
...
getOptions_idcompania = async (url,referencia) =>{
    ...
    cargarDatos = async ()=>{
		const{idcompania,nombre} = this.state.form;
...
<>
     ...
     <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Compañia</h6>
                                        <select className="form-control" placeholder="Compañia" name="idcompania" onChange={this.cambioValor} value={form.idcompania} >
