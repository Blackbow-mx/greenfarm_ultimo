...
let apiEliminarRegistros = "admin/tiposinsumos/delete/";
let localListarRegistros = "/tiposinsumos/listar";
let apiConsultaRegistro  = "admin/tiposinsumos/listar/";
let apiConfig            = "admin/tiposinsumos/init/"
...
class Tiposinsumos  extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            datosCargados: false,
...
descripcion:"",
   ...
   // console.log("boton: " + e.target.id);
    ...
    cargarDatos = async ()=>{
		const{descripcion} = this.state.form;
