...
let apiEliminarRegistros = "admin/distribuidores/delete/";
let localListarRegistros = "/distribuidores/listar";
let apiConsultaRegistro  = "admin/distribuidores/listar/";
let apiConfig            = "admin/distribuidores/init/"
...
nombre:"",
    ...
    cargarDatos = async ()=>{
		const{domicilio,codigo,nombre} = this.state.form;
...
<>
 ...
 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
            <h6 style={{marginbottom: "0px",width: "100%"}}>Codigo</h6><input  style={{borderradius: "2px",border: "1px solid rgb(217,217,217)",marginTop: "2%",width: "100%"}}  className="form-control form-control-sm" type="text"   name="codigo" onChange={this.cambioValor} value={this.state.form.codigo}  />
        </div>
 <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" style={{paddingBottom: "12px",height: "auto"}}>
